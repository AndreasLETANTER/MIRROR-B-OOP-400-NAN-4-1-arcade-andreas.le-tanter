...
static std::map<int, std::pair<ObjectType, std::pair<int, int>>> GameSimulation(int keypressed)
{
    ...
    _ObjectData[0] = std::make_pair(ObjectType::PLAYER, std::make_pair(10,  20));               //create a player at position 10, 20
    _ObjectData[1] = std::make_pair(ObjectType::ENEMY, std::make_pair(5, 20));                  //create an enemy at position 5, 20
    _ObjectData[3] = std::make_pair(ObjectType::ITEM, std::make_pair(8, 30));                   //create an item at position 8, 30
    _ObjectData[4] = std::make_pair(ObjectType::ITEM, std::make_pair(10, 60));                  //create an item at position 10, 60
...
int main(int argc, char **argv)
{
    ...
    do {
        ...
        _Init->getGraphicalInstances()[0]->getInstance()->displayScore(0);                      //display score
